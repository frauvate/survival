...
public class Player {
    ...
    public void pickLocation() {
        ...
        while (noLocPickedYet || location.onLocation()){
            ...
            System.out.println("3 - Cave - You can find water in the cave. But be careful there are zombies.");
            System.out.println("4 - Forest - You can find wood in the forest. But be careful there are wolves.");
            System.out.println("5 - Castle - You can find food in the castle. But be careful there are vampires.");
